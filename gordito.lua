...
-- y=-180: Umbrales
local clickLowEB  = CreateClickInput("Aviso:", "clickLow", 20, -185, 25)
local clickHighEB = CreateClickInput("Alerta:", "clickHigh", 155, -185, 25)

-- y=-210: Tiempos
local debounceEB  = CreateClickInput("Poner(s):", "startingDebounce", 20, -210, 30)
local announceCooldownEB = CreateClickInput("Grito(s):", "announceCooldown", 155, -210, 30)
...
local msgLowEB  = CreateTextInput("Mensaje Aviso (%n=nombre):", "msgLow", 20, -265)
local msgHighEB = CreateTextInput("Mensaje Alerta (%n=nombre):", "msgHigh", 20, -325)
...
local feastDurationSlider = CreateGorditoSlider("Segs. Seguimiento", "feastDuration", 20, -400, 30, 600)
...
local greedyScroll = CreateFrame("ScrollFrame", "GorditoGreedyScroll", mainFrame)
greedyScroll:SetPoint("TOPLEFT",     mainFrame, "TOPLEFT",     295, -60)
greedyScroll:SetPoint("BOTTOMRIGHT", mainFrame, "TOPLEFT",     535, -235)

local greedyScrollChild = CreateFrame("Frame")
...
local greedyScrollBar = CreateFrame("Slider", "GorditoGreedyScrollBar", mainFrame, "UIPanelScrollBarTemplate")
...
local scrollFrame = CreateFrame("ScrollFrame", "GorditoScrollFrame", mainFrame)
...
local scrollBar = CreateFrame("Slider", "GorditoScrollBar", mainFrame, "UIPanelScrollBarTemplate")
...
btnIcon:SetTexture("Interface\\Addons\\gordito\\gordito.tga")
...
f:SetScript("OnEvent", function(self, event, ...)
    ...
    if event == "COMBAT_LOG_EVENT_UNFILTERED" then
        ...
        if debugMode and spellId and (FEAST_PLACE_IDS[spellId] or spellId == 57426) then
